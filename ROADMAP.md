...
## Текущее состояние: v1.3.1 (2026-08-31)
...
## История релизов
- **v1.3.1** — assetname = имя .blend-проекта (фолбэк — скоуп); пресет 2048×858
...
### v1.4.0 — Пресеты съёмки
- Встроенные: Front / Three-Quarter / Top / Hero (низкий ракурс)
- Пользовательские JSON-пресеты в папке — синхронно с подходом LAMPOCHKA
  v3.1 (живой подхват), после подготовки пресетов юзером
- Пресет = Radius/Height/Dir/Rounds/Lens/Mode/Center
